...
@Component({
  ...
  template: `
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-blue-50 px-4 relative">
      <!-- Botón volver al inicio -->
      <a 
        routerLink="/"
        class="absolute top-4 left-4 flex items-center gap-2 px-4 py-2 bg-white border-2 border-gray-300 rounded-lg text-gray-700 font-semibold text-sm hover:bg-green-600 hover:text-white hover:border-green-600 transition-all shadow-sm hover:shadow-md"
