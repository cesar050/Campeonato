...
export class VerSolicitudesComponent implements OnInit {
  ...
  aprobarInscripcion(inscripcion: Inscripcion): void {
    ...
    this.confirmDialogTitle.set('Aprobar inscripción');
    this.confirmDialogMessage.set(`¿Estás seguro de aprobar la inscripción del equipo "${inscripcion.equipo?.nombre || 'N/A'}"?`);
    this.confirmDialogType.set('warning');
    this.confirmAction.set(() => {
      this.aprobarInscripcionConfirmado();
    });
  }

  aprobarInscripcionConfirmado(): void {
