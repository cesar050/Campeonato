...
export const routes: Routes = [
  ...
  // Public pages
  {
    path: 'bienvenido',
    loadComponent: () =>
      import('./features/bienvenido/bienvenido').then(m => m.BienvenidoComponent)
  },
  {
    path: 'sobre-nosotros',
    loadComponent: () =>
      import('./features/sobre-nosotros/sobre-nosotros').then(m => m.SobreNosotrosComponent)
  },
  {
    path: 'precios',
    loadComponent: () =>
      import('./features/precios/precios').then(m => m.PreciosComponent)
  },
